...
import com.codepath.simpleinstagram.databinding.FragmentComposeBinding;
import com.codepath.simpleinstagram.databinding.FragmentPostsBinding;
    ...
    protected void queryPosts() {
        ...
        query.findInBackground(new FindCallback<Post>() {
            ...
            public void done(List<Post> posts, ParseException e) {
                ...
                for(Post post: posts){
                    Log.i(TAG, "Post"+post.getDescription()+" username: "+ post.getUser().getUsername() + " timestamp: " + post.getUser().getCreatedAt());
                }
                adapter.clear();
